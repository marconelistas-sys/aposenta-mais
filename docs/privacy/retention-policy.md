...
Quando o usuário autoriza a sincronização, uma cópia financeira permanece no PostgreSQL do Supabase até a ação “Excluir cópia remota” ou a exclusão da conta. O registro de consentimento ocupa a mesma linha e é eliminado junto com a cópia. Os prazos de descarte em backups gerenciados pelo provedor ainda precisam de definição operacional.
