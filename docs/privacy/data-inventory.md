...
| Carteira de investimentos | dado pessoal financeiro | usuário | nome escolhido, classe, saldo, aporte, tipo de taxa, rendimento, referência do CDI e liquidez declarada por investimento | calcular a projeção de cada saldo, explicar o impacto dos rendimentos e classificar a liquidez | local e na cópia remota até a exclusão correspondente |
| Contas manuais | dado pessoal financeiro | usuário | nome, moeda, saldo e data inicial, entradas, saídas e valores de origem e destino de transferências | calcular saldo por conta sem dupla contagem no orçamento | local e na cópia remota até exclusão correspondente |
