...
export function renderCashFlowTimeline() {
  ...
  return `<section class="panel settings-card" aria-labelledby="timeline-title">
    ...
    <p>${state.cashFlow.retirementMonth ? 'Mês confirmado' : 'Sugestão pelas idades do plano, ainda não confirmada'}: ${retirement}. Receitas vinculadas terminam no mês anterior. Datas manuais não mudam. Este mês controla o orçamento, não altera as idades ou o prazo da projeção patrimonial. Se alterar as idades, revise este mês.</p>
