...
export function planningChart({ title, rows, series, bands = [], currency, hidden, markers = [], details = [], selectedYear, interpolation = 'monotone' }) {
  ...
  const initialIndex = cashFlowDetailIndex(details, selectedYear)
